...
_RandMax:
	...
	jsr	_umodhi3
	leas	2,s	;,,
	tfr	x,d	;movlsbqihi: R:x -> R:b	; tmp41, D.3122
L95:
	leas	3,s	;,,
	rts
	.globl	__fl_s
...
L360:
	...
	stb	,x+	;,
	ldb	_stringBuffer4+1	; D.3307, stringBuffer4
	beq	L362	;
	stb	,x+	; D.3307,
L362:
	ldb	_stringBuffer4+2	; D.3309, stringBuffer4
	beq	L363	;
	stb	,x+	; D.3309,
L363:
...
L382:
	...
	ldb	_stringBuffer4	;, stringBuffer4
	stb	,u+	;,
	ldb	_stringBuffer4+1	; D.3337, stringBuffer4
	beq	L384	;
	stb	,u+	; D.3337,
L384:
	ldb	_stringBuffer4+2	; D.3339, stringBuffer4
	beq	L385	;
	stb	,u+	; D.3339,
L385:
	ldb	,x	; c,* s1.679
	beq	L386	;
	leax	1,x	; s1.677,, s1.679
L387:
	stb	,u+	; c,
	ldb	,x+	; c,
	bne	L387	;
...
__fii:
	...
	bra	L428	;
L436:
	leau	,y	; ivtmp.833, ivtmp.850
L428:
	ldb	9,s	;, c.851
	stb	_stringBuffer40,u	;,
	leay	1,u	; ivtmp.850,, ivtmp.833
	leax	_stringBuffer40,y	;,, ivtmp.850
	stx	5,s	;, to.847
	ldd	1,s	;, s1
	leax	d,u	; tmp47,, ivtmp.833
	ldb	1,x	;,
	stb	9,s	;, c.851
	tfr	u,d	; ivtmp.833, tmp48
	addd	#2; addhi3,3	; tmp48,
	addd	1,s; addhi3,3	; tmp48, s1
	std	10,s	; tmp48, s1.852
	ldb	9,s	;, c.851
	cmpb	#37	;cmpqi:	;,
	bne	L436	;
L427:
	...
	stb	,x+	;,
	ldb	_stringBuffer4+2	;, stringBuffer4
	leax	1,x	; to.839,, to.839
	stx	3,s	; to.839, to.840
	leax	-1,x	; to.839,, to.839
	stb	,x+	;,
	ldb	18,s	;, i2
	jsr	_itoa
...
L430:
	ldd	5,s	;, to.847
	leax	d,u	; tmp52,, ivtmp.825
	ldb	,s	;, c.849
	stb	3,x	;,
	leax	4,u	; tmp53,, ivtmp.825
	exg	d,x	;, tmp53
	addd	5,s; addhi3,3	;, to.847
	exg	d,x	;, tmp53
	stx	3,s	; tmp53, to.840
	ldd	10,s	;, s1.852
	leax	d,u	; tmp54,, ivtmp.825
	ldb	1,x	;,
	stb	,s	;, c.849
	leax	2,u	; tmp55,, ivtmp.825
	exg	d,x	;, tmp55
	addd	10,s; addhi3,3	;, s1.852
	exg	d,x	;, tmp55
	stx	7,s	; tmp55, s1.848
	leau	1,u	; ivtmp.825,, ivtmp.825
	cmpb	#37	;cmpqi:	;,
	bne	L430	;
L429:
	ldx	3,s	; to.842, to.840
	ldb	_stringBuffer4	;, stringBuffer4
	stb	,x+	;,
	ldb	_stringBuffer4+1	;, stringBuffer4
	stb	,x+	;,
	leay	,x	; to.846, to.844
	ldb	_stringBuffer4+2	;, stringBuffer4
	stb	,y+	;,
	ldx	7,s	;, s1.848
	ldb	,x	;,
...
L432:
	ldd	3,s	;, to.840
	leax	d,u	; tmp59,, ivtmp.817
	ldb	,s	;, c
	stb	3,x	;,
	leax	4,u	; tmp60,, ivtmp.817
	ldd	3,s	;, to.840
	leay	d,x	; to.846,, tmp60
	ldd	7,s	;, s1.848
	leax	d,u	; tmp61,, ivtmp.817
	ldb	1,x	;,
	stb	,s	;, c
	leau	1,u	; ivtmp.817,, ivtmp.817
	tstb	;
	bne	L432	;
L431:
	ldb	#-128	;,
...
L440:
	...
	leay	_stringBuffer40,x	; to,,
	ldd	,s	;, s1
	leax	d,u	; tmp40,, ivtmp.892
	ldb	1,x	;,
	stb	4,s	;, c.893
	tfr	u,d	; ivtmp.892, tmp41
	addd	#2; addhi3,3	; tmp41,
	ldx	,s	;, s1
	leau	d,x	; s1.894, tmp41,
	ldb	4,s	;, c.893
	cmpb	#37	;cmpqi:	;,
	bne	L448	;
L439:
	ldb	_stringBuffer6	; c.891, stringBuffer6
	beq	L441	;
	ldx	#_stringBuffer6+1	; s2,
L442:
	stb	,y+	; c.891,
...
__fsl_s:
	...
	stb	8,s	;, c.944
	leas	2,s	;,,
	ldu	#_stringBuffer40	; to.938,
	cmpb	#37	;cmpqi:	;,
	beq	L451	;
	ldy	#0	; ivtmp.939,
	bra	L452	;
L469:
	ldy	4,s	; ivtmp.939, ivtmp.931
L452:
	ldb	6,s	;, c.944
	stb	_stringBuffer40,y	;,
	leax	1,y	;,, ivtmp.939
	stx	4,s	;, ivtmp.931
	leau	_stringBuffer40,x	; to.938,,
	ldd	2,s	;, s1
	leax	d,y	; tmp49,, ivtmp.939
	ldb	1,x	;,
	stb	6,s	;, c.944
	tfr	y,d	; ivtmp.939, tmp50
...
L455:
	ldb	_stringBuffer6	;, stringBuffer6
	stb	,u+	;,
	ldb	_stringBuffer6+1	; D.3464, stringBuffer6
	beq	L457	;
	stb	,u+	; D.3464,
L457:
	ldb	_stringBuffer6+2	; D.3466, stringBuffer6
	beq	L458	;
	stb	,u+	; D.3466,
L458:
	ldb	_stringBuffer6+3	; D.3468, stringBuffer6
	beq	L459	;
	stb	,u+	; D.3468,
L459:
	ldb	_stringBuffer6+4	; D.3470, stringBuffer6
	beq	L460	;
	stb	,u+	; D.3470,
L460:
	ldb	_stringBuffer6+5	; D.3472, stringBuffer6
	beq	L461	;
	stb	,u+	; D.3472,
L461:
	ldb	,x	; c,* s1.943
	beq	L462	;
	leax	1,x	; s1.937,, s1.943
L463:
	stb	,u+	; c,
	ldb	,x+	; c,
	bne	L463	;
...
L473:
	...
	leau	_stringBuffer40,x	; to,,
	ldd	,s	;, s1
	leax	d,y	; tmp46,, ivtmp.998
	ldb	1,x	;,
	stb	4,s	;, c.1004
	tfr	y,d	; ivtmp.998, tmp47
	addd	#2; addhi3,3	; tmp47,
	ldx	,s	;, s1
	leay	d,x	; s1.1005, tmp47,
	ldb	4,s	;, c.1004
	cmpb	#37	;cmpqi:	;,
	bne	L489	;
L472:
	ldb	_stringBuffer12	; c.1003, stringBuffer12
	beq	L488	;
...
L488:
	...
	bne	L483	;
L490:
	ldb	_stringBufferExtra	; c.999, stringBufferExtra
	beq	L478	;
...
L494:
	...
	leay	_stringBuffer40,x	; to,,
	ldd	,s	;, s1
	leax	d,u	; tmp39,, ivtmp.1045
	ldb	1,x	;,
	stb	4,s	;, c.1046
	tfr	u,d	; ivtmp.1045, tmp40
	addd	#2; addhi3,3	; tmp40,
	ldx	,s	;, s1
	leau	d,x	; s1.1047, tmp40,
	ldb	4,s	;, c.1046
	cmpb	#37	;cmpqi:	;,
	bne	L502	;
L493:
	ldb	_stringBuffer12	; c.1044, stringBuffer12
	beq	L495	;
	ldx	#_stringBuffer12+1	; from,
L496:
	stb	,y+	; c.1044,
...
_printfsi:
	...
	ldb	,x+	;,
	stb	11,s	;, c.1102
	ldy	#_stringBuffer40	; to.1095,
	cmpb	#37	;cmpqi:	;,
	beq	L505	;
	ldu	#0	; ivtmp.1099,
	bra	L506	;
L518:
	ldu	5,s	; ivtmp.1099, ivtmp.1088
L506:
	ldb	11,s	;, c.1102
	stb	_stringBuffer40,u	;,
	leax	1,u	;,, ivtmp.1099
	stx	5,s	;, ivtmp.1088
	leay	_stringBuffer40,x	; to.1095,,
	ldd	3,s	;, s1
	leax	d,u	; tmp46,, ivtmp.1099
	ldb	1,x	;,
	stb	11,s	;, c.1102
	tfr	u,d	; ivtmp.1099, tmp47
	addd	#2; addhi3,3	; tmp47,
	ldx	3,s	;, s1
	leax	d,x	;, tmp47,
	stx	1,s	;, s1.1103
...
L509:
	...
	stb	,x+	;,
	ldb	_stringBuffer4+2	;, stringBuffer4
	leax	1,x	; to.1094,, to.1094
	stx	7,s	; to.1094, to.1096
	leax	-1,x	; to.1094,, to.1094
	stb	,x+	;,
	ldx	9,s	;, s1.1098
	ldb	,x	;,
...
L512:
	tfr	y,d	; to.1095,
	leax	d,u	; tmp51,, ivtmp.1066
	ldb	,s	;, c
	stb	3,x	;,
	leax	4,u	; tmp52,, ivtmp.1066
	tfr	y,d	; to.1095,
	leax	d,x	;,, tmp52
	stx	7,s	;, to.1096
	ldd	9,s	;, s1.1098
	leax	d,u	; tmp53,, ivtmp.1066
	ldb	1,x	;,
	stb	,s	;, c
	leau	1,u	; ivtmp.1066,, ivtmp.1066
	tstb	;
	bne	L512	;
L511:
	ldb	#-128	;,
...
_vstrlen:
	...
	ldb	,x	; temp.1123,* s
	beq	L520	;
	cmpb	#-128	;cmpqi:	; temp.1123,
	bne	L522	;
	bra	L520	;
L525:
	cmpb	#-128	;cmpqi:	; D.3560,
	beq	L521	;
L522:
	...
	subb	,s	; tmp49, t
	stb	,s	; tmp49, t
	tfr	x,d	;movlsbqihi: R:x -> R:b	; s.1122, s.1122
	addb	,s	; s.1122, t
	stb	,s	; s.1122, t
	leax	1,x	; s.1122,, s.1122
	ldb	,x	; D.3560,* s.1122
	bne	L525	;
L521:
	ldb	,s	;, t
...
_lRandMax:
	...
	leas	2,s	;,,
	tfr	x,d	;, tmp41
	clra		;zero_extendqihi: R:b -> R:d	; tmp41, prephitmp.1170
	tfr	d,x	; prephitmp.1170,
	leas	3,s	;,,
	rts
L544:
	ldd	#0	; prephitmp.1170,
	tfr	d,x	; prephitmp.1170,
	leas	3,s	;,,
	rts
