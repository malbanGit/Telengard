# 1 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\string.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\string.c"


# 1 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../string.i" 1
...
# 4 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../string.i" 2
...
# 142 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../string.h"
...
# 5 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../string.i" 2




__attribute__((noinline)) void vstrcpy(char * dest, char *source)
{
    do
    {
        *(dest++) = *(source++);
...
__attribute__((noinline)) char* removeSpaces(char *pointer)
{
...
__attribute__((noinline)) char * itoa(unsigned int n)
{
    long digit = '0'*256+'0';
    int useSpace = 0;
...
__attribute__((noinline)) char * _ltoa(unsigned long n, char *pointer, int zeroToSpaces)
{
    long digit = '0'*256+'0';
    int useSpace = 0;
...
# 168 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../string.i"
...
# 195 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../string.i"
__attribute__((noinline)) char * _lltoa(unsigned long long n, char *pointer)
{
    long digit = '0'*256+'0';
    int useSpace = 0;
...
# 283 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../string.i"
char * lltoa_s(unsigned long long n)
{
    lltoa(n);
    return removeSpaces(stringBuffer12);
}
# 297 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../string.i"
__attribute__((noinline)) void _fll_s(const char *s1, const unsigned long long int i)
{
    lltoa(i);
...
# 369 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../string.i"
void setRandSeedNP()
{
    _a = 73-_x;
...
void initString()
{
    do {_x = ((unsigned int)(11));setRandSeedNP();} while(0);
...
__attribute__((noinline)) char * itoa_s_s(signed int n)
{
    int sign=0;
    if (n<0)
    {
...
__attribute__((noinline)) void _fss(const char *s1, const char *s2, const char *s3)
{
    char *to = stringBuffer40;
    char c;
    while ( (c=*(s1++)) != '%')
...
# 479 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../string.i"
__attribute__((noinline)) void _fsi2_s(const char *s1, const unsigned int i, const char *s2)
{
    itoa_s(i);
    char *to = stringBuffer40;
    char c;
...
# 509 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../string.i"
__attribute__((noinline)) void _fsi_s(const char *s1, const char *s2, const unsigned int i)
{
    itoa_s(i);
    char *to = stringBuffer40;
    char c;
...
# 537 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../string.i"
__attribute__((noinline)) void _fsi2(const char *s1, const unsigned int i, const char *s2)
{
    itoa(i);
    char *to = stringBuffer40;
    char c;
...
# 567 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../string.i"
__attribute__((noinline)) void _fsi(const char *s1, const char *s2, const unsigned int i)
{
    itoa(i);
    char *to = stringBuffer40;
    char c;
...
__attribute__((noinline)) void _fii(const char *s1, const unsigned int i1, const unsigned int i2)
{
    itoa(i1);
    char *to = stringBuffer40;
    char c;
...
__attribute__((noinline)) void _fl(const char *s1, const unsigned long i)
{
    ltoa(i);
    char *to = stringBuffer40;
    char *s2 = stringBuffer6;
...
__attribute__((noinline)) void _fsl_s(const char *s1, const char *s2, const unsigned long int i)
{
    ltoa_s(i);
    char *to = stringBuffer40;
    char c;
...
__attribute__((noinline)) void _fl_l_s(const char *s1, const unsigned long i1, const unsigned long i2)
{
...
# 689 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../string.i"
__attribute__((noinline)) void _fll(const char *s1, const unsigned long long int i)
{
    lltoa(i);
    char *to = stringBuffer40;
    char *from = stringBuffer12;
...
void printfsi(const char *s1, const char *s2, const unsigned int i)
{
    ...
    *(to++) = c;
    *to = '\x80';
    do {syncPrintStrd((const int)(_XC), (const int)((_YC-=0x0a)), (void *)((void* const)(stringBuffer40)));dp_VIA_cntl = 0xcc;;} while (0);
}
...
void displayMessages()
{
    ...
    {
        do {syncPrintStrd((const int)(_XC), (const int)((_YC-=0x0a)), (void *)((void* const)(msg[i])));dp_VIA_cntl = 0xcc;;} while (0);
    }
}
...
# 4 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\string.c" 2
