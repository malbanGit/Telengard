...
# 34 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\main.c"
extern void subBank0(int);
# 49 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\main.c"
...
# 64 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\main.c" 2
...
# 65 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\main.c" 2
...
# 69 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\main.c" 2
# 1 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../globalsDef.h" 1
       
# 20 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../globalsDef.h"
...
# 64 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../globalsDef.h"
...
unsigned long int tmp_inventory[10];
...
unsigned int s[6];
unsigned long int inventory[10];
...
int _y_;
int _x_;
# 170 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../globalsDef.h"
int _XC;
int _YC;
...
unsigned int __b;
unsigned int __c;
# 208 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../globalsDef.h"
...
# 298 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\/../globalsDef.h"
unsigned int FP0EXP;
unsigned int FPA0[4];
unsigned int FP0SGN;
...
# 70 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\main.c" 2
...
# 71 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\main.c" 2
# 107 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\main.c"
...
# 128 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\main.c"
...
monsterAgain:
    ...
    if ( (unsigned long int)(RandMax(20)+1) <= inventory[3] )
    {
...
monsterSet:
    ...
    ml = ml - RandMax(ml);
# 376 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\main.c"
...
monsterForced:
    ...
    if ( (sf[7] >0) && (un == 1) && (RandMax(100)<20) )
        goto monsterAgain;
# 408 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\main.c"
    do{msgLine = 0;}while (0);
    _fsi2_s("YOU ENCOUNTER A LVL % %", ml, mo[m]);
    printMessage(stringBuffer40);
# 426 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\main.c"
    l=ml;
    tmp = 0;
...
evadeOut:
        ...
        case 4:
        {
            ...
            do{msgLine = 0;}while (0);
            printMessage("FIGHT");
            ltmp = RandMax(20) + lv + (signed long int)inventory[0] + s[0]/2;
            ...
            else
            {
                ...
                ltmp += (signed long int) RandMax(lv*2) + (signed long int)inventory[0] + 1;
...
label3305:
            ...
            ltmp = (signed long int)(RandMax(20) + ml -inventory[1] - inventory[2] + mb);



            if ((m>=16) && (m<=17))
            {
                if (sf[3] > 0) ltmp = ltmp -6;
            }
...
# 962 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\main.c"
            if (m == 19)
            {
                if (RandMax(10)>3)
                {
...
{
    do{msgLine = 0;}while (0);
# 1366 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\main.c"
...
doElevator:
        ...
        case 2:
        {
            ...
            else
            {
                ...
                if ((unsigned long int )RandMax(20)<= (unsigned long int) s[4]+inventory[4])
                    tmp = 1;
            }
            if (tmp == 1)
            {
...
# 2086 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\main.c"
...
restart:
    ...
    createCharacter();
# 2175 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank1\\main.c"
...
newTurnNotStart:
            ...
            {
                ch=ch+(signed long int)inventory[5];
