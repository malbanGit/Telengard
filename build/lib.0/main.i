# 1 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c"
# 1 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../deps.h" 1
# 2 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c" 2
# 39 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c"
...
# 40 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c" 2
# 1 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../BothBanks.i" 1
       
# 1 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../string.h" 1
       
# 18 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../string.h"
extern int _XC;
extern int _YC;
extern int msgLine;
...
# 84 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../string.h"
...
# 111 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../string.h"
...
# 3 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../BothBanks.i" 2
# 1 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../controller.h" 1




       
# 16 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../controller.h"
...
# 4 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../BothBanks.i" 2
# 1 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../roomDefines.h" 1
       
# 5 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../BothBanks.i" 2
# 41 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c" 2
# 1 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../globalsDef.h" 1
       
# 22 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../globalsDef.h"
...
# 66 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../globalsDef.h"
...
int _y_;
int _x_;
# 171 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../globalsDef.h"
int _XC;
int _YC;
...
unsigned int __b;
unsigned int __c;
# 204 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../globalsDef.h"
...
# 294 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/../globalsDef.h"
unsigned int FP0EXP;
unsigned int FPA0[4];
unsigned int FP0SGN;
...
# 42 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c" 2

# 1 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/constants.h" 1
       


const unsigned char const FP_X0_PACKED[5] = {0x81,0x58,0x83,0x12,0x6e};
const unsigned char const FP_Y0_PACKED[5] = {0x81,0x36,0xc2,0x26,0x82};
const unsigned char const FP_Z0_PACKED[5] = {0x81,0x1f,0x83,0x7b,0x4A};
const unsigned long int W0 = 4694;
...
# 44 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c" 2
# 1 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/float40.h" 1
       
# 15 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/float40.h"
...
extern const unsigned char const FP_X0_PACKED[5];
extern const unsigned char const FP_Y0_PACKED[5];
extern const unsigned char const FP_Z0_PACKED[5];


void initFP();

void intF(unsigned char *in, unsigned char *out);
long int toInt(unsigned char *in);
...
# 45 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c" 2

# 1 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\/sounds.h" 1
...
# 47 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c" 2
# 87 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c"
...
# 101 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c"
...
# 245 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c"
...
# 342 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c"
unsigned long int getMapPos(unsigned char x, unsigned char y, unsigned char z)
{
# 352 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c"
    ...
    if ((h&0xff00) > 0)
    {
        ...
        h2 += 1;
# 416 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c"
        if (h2 >9) h2 = 0;
...
# 442 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c"
...
static inline __attribute__((always_inline)) void drawRoom(unsigned int content,unsigned int drawUp,unsigned int drawLeft, signed int ry, signed int rx)
{
...
# 618 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c"
void drawMap()
{
    if (fillMap != 0) generateDisplayMap();


    printEnvironment = (int)(*(((char *) (((unsigned long int *)screen)+4+1)) +0));
    if (above == 4) printEnvironment = 4;
    ...
    if (specialAction)
    {
        if (specialAction == 1)
        {
            ...
            dp_VIA_t1_cnt_lo = 0x09;
            drawFlame();
            if (sfx_status_1==0) initSoundNo = 4;
        }
        else if (specialAction == 2)
        {
            if (sfx_status_1==0) initSoundNo = 3;
        }
    }
    if (initSoundNo)
    {
    ...
    drawRoom(((sf[2]==0)?(unsigned int)0:((unsigned int)(((((unsigned int) (((((!((((*(((char *) (((unsigned long int *)screen)+4+0)) +1)))&3)>1)) && (!((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))&12)>4))) || ((!((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))&3)>1)) && (!((((*(((char *) (((unsigned long int *)screen)+0+1)) +1)))&12)>4))) ))?((((((*(((char *) (((unsigned long int *)screen)+0+0)) +0)))>0) && (((*(((char *) (((unsigned long int *)screen)+0+0)) +0)))<10))?((*(((char *) (((unsigned long int *)screen)+0+0)) +0))):0)):(0))))>0)?10:0))), (((!((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))&3)>1)) && (!((((*(((char *) (((unsigned long int *)screen)+0+1)) +1)))&12)>4))))?((((*(((char *) (((unsigned long int *)screen)+0+0)) +1)))&3)):(0), (((!((((*(((char *) (((unsigned long int *)screen)+4+0)) +1)))&3)>1)) && (!((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))&12)>4))))?(((((*(((char *) (((unsigned long int *)screen)+0+0)) +1)))>>2)&3)):(0), ((signed char) ( 127-((signed long)(0)*85))), ((signed char) (-128+((signed long)(0)*85))));
    drawRoom(((sf[2]==0)?(unsigned int)0:((unsigned int)(((((unsigned int) (((!((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))&3)>1)))?((((((*(((char *) (((unsigned long int *)screen)+0+1)) +0)))>0) && (((*(((char *) (((unsigned long int *)screen)+0+1)) +0)))<10))?((*(((char *) (((unsigned long int *)screen)+0+1)) +0))):0)):(0))))>0)?10:0))), ((!((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))&3)>1)))?((((*(((char *) (((unsigned long int *)screen)+0+1)) +1)))&3)):(0), ((!((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))&3)>1)))?(((((*(((char *) (((unsigned long int *)screen)+0+1)) +1)))>>2)&3)):(0), ((signed char) ( 127-((signed long)(0)*85))), ((signed char) (-128+((signed long)(1)*85))));
    drawRoom(((sf[2]==0)?(unsigned int)0:((unsigned int)(((((unsigned int) (((((!((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))&3)>1)) && (!((((*(((char *) (((unsigned long int *)screen)+0+2)) +1)))&12)>4))) || ((!((((*(((char *) (((unsigned long int *)screen)+4+2)) +1)))&3)>1)) && (!((((*(((char *) (((unsigned long int *)screen)+4+2)) +1)))&12)>4))) ))?((((((*(((char *) (((unsigned long int *)screen)+0+2)) +0)))>0) && (((*(((char *) (((unsigned long int *)screen)+0+2)) +0)))<10))?((*(((char *) (((unsigned long int *)screen)+0+2)) +0))):0)):(0))))>0)?10:0))), (((!((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))&3)>1)) && (!((((*(((char *) (((unsigned long int *)screen)+0+2)) +1)))&12)>4))))?((((*(((char *) (((unsigned long int *)screen)+0+2)) +1)))&3)):(0), ((1))?(((((*(((char *) (((unsigned long int *)screen)+0+2)) +1)))>>2)&3)):(0), ((signed char) ( 127-((signed long)(0)*85))), ((signed char) (-128+((signed long)(2)*85))));
    drawRoom(0, ((0))?((((*(((char *) (((unsigned long int *)screen)+0+3)) +1)))&3)):(0), (((!((((*(((char *) (((unsigned long int *)screen)+4+2)) +1)))&3)>1)) && (!((((*(((char *) (((unsigned long int *)screen)+4+2)) +1)))&12)>4))))?(((((*(((char *) (((unsigned long int *)screen)+0+3)) +1)))>>2)&3)):(0), ((signed char) ( 127-((signed long)(0)*85))), ((signed char) (-128+((signed long)(3)*85))));

    drawRoom(((sf[2]==0)?(unsigned int)0:((unsigned int)(((((unsigned int) (((!((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))&12)>4)))?((((((*(((char *) (((unsigned long int *)screen)+4+0)) +0)))>0) && (((*(((char *) (((unsigned long int *)screen)+4+0)) +0)))<10))?((*(((char *) (((unsigned long int *)screen)+4+0)) +0))):0)):(0))))>0)?10:0))), ((!((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))&12)>4)))?((((*(((char *) (((unsigned long int *)screen)+4+0)) +1)))&3)):(0), ((!((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))&12)>4)))?(((((*(((char *) (((unsigned long int *)screen)+4+0)) +1)))>>2)&3)):(0), ((signed char) ( 127-((signed long)(1)*85))), ((signed char) (-128+((signed long)(0)*85))));

    drawRoom(0, ((1))?((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))&3)):(0), ((1))?(((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))>>2)&3)):(0), ((signed char) ( 127-((signed long)(1)*85))), ((signed char) (-128+((signed long)(1)*85))));
    drawRoom(((sf[2]==0)?(unsigned int)0:((unsigned int)(((((unsigned int) (((!((((*(((char *) (((unsigned long int *)screen)+4+2)) +1)))&12)>4)))?((((((*(((char *) (((unsigned long int *)screen)+4+2)) +0)))>0) && (((*(((char *) (((unsigned long int *)screen)+4+2)) +0)))<10))?((*(((char *) (((unsigned long int *)screen)+4+2)) +0))):0)):(0))))>0)?10:0))), ((!((((*(((char *) (((unsigned long int *)screen)+4+2)) +1)))&12)>4)))?((((*(((char *) (((unsigned long int *)screen)+4+2)) +1)))&3)):(0), ((1))?(((((*(((char *) (((unsigned long int *)screen)+4+2)) +1)))>>2)&3)):(0), ((signed char) ( 127-((signed long)(1)*85))), ((signed char) (-128+((signed long)(2)*85))));
    drawRoom(0, ((0))?((((*(((char *) (((unsigned long int *)screen)+4+3)) +1)))&3)):(0), ((!((((*(((char *) (((unsigned long int *)screen)+4+2)) +1)))&12)>4)))?(((((*(((char *) (((unsigned long int *)screen)+4+3)) +1)))>>2)&3)):(0), ((signed char) ( 127-((signed long)(1)*85))), ((signed char) (-128+((signed long)(3)*85))));

    drawRoom(((sf[2]==0)?(unsigned int)0:((unsigned int)(((((unsigned int) (((((!((((*(((char *) (((unsigned long int *)screen)+8+0)) +1)))&3)>1)) && (!((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))&12)>4))) || ((!((((*(((char *) (((unsigned long int *)screen)+8+1)) +1)))&3)>1)) && (!((((*(((char *) (((unsigned long int *)screen)+8+1)) +1)))&12)>4))) ))?((((((*(((char *) (((unsigned long int *)screen)+8+0)) +0)))>0) && (((*(((char *) (((unsigned long int *)screen)+8+0)) +0)))<10))?((*(((char *) (((unsigned long int *)screen)+8+0)) +0))):0)):(0))))>0)?10:0))), ((!((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))&12)>4)))?((((*(((char *) (((unsigned long int *)screen)+8+0)) +1)))&3)):(0), (((!((((*(((char *) (((unsigned long int *)screen)+8+0)) +1)))&3)>1)) && (!((((*(((char *) (((unsigned long int *)screen)+4+1)) +1)))&12)>4))))?(((((*(((char *) (((unsigned long int *)screen)+8+0)) +1)))>>2)&3)):(0), ((signed char) ( 127-((signed long)(2)*85))), ((signed char) (-128+((signed long)(0)*85))));
    drawRoom(((sf[2]==0)?(unsigned int)0:((unsigned int)(((((unsigned int) (((!((((*(((char *) (((unsigned long int *)screen)+8+1)) +1)))&3)>1)))?((((((*(((char *) (((unsigned long int *)screen)+8+1)) +0)))>0) && (((*(((char *) (((unsigned long int *)screen)+8+1)) +0)))<10))?((*(((char *) (((unsigned long int *)screen)+8+1)) +0))):0)):(0))))>0)?10:0))), ((1))?((((*(((char *) (((unsigned long int *)screen)+8+1)) +1)))&3)):(0), ((!((((*(((char *) (((unsigned long int *)screen)+8+1)) +1)))&3)>1)))?(((((*(((char *) (((unsigned long int *)screen)+8+1)) +1)))>>2)&3)):(0), ((signed char) ( 127-((signed long)(2)*85))), ((signed char) (-128+((signed long)(1)*85))));
    drawRoom(((sf[2]==0)?(unsigned int)0:((unsigned int)(((((unsigned int) (((((!((((*(((char *) (((unsigned long int *)screen)+8+2)) +1)))&3)>1)) && (!((((*(((char *) (((unsigned long int *)screen)+4+2)) +1)))&12)>4))) || ((!((((*(((char *) (((unsigned long int *)screen)+8+1)) +1)))&3)>1)) && (!((((*(((char *) (((unsigned long int *)screen)+8+2)) +1)))&12)>4))) ))?((((((*(((char *) (((unsigned long int *)screen)+8+2)) +0)))>0) && (((*(((char *) (((unsigned long int *)screen)+8+2)) +0)))<10))?((*(((char *) (((unsigned long int *)screen)+8+2)) +0))):0)):(0))))>0)?10:0))), ((!((((*(((char *) (((unsigned long int *)screen)+4+2)) +1)))&12)>4)))?((((*(((char *) (((unsigned long int *)screen)+8+2)) +1)))&3)):(0), ((!((((*(((char *) (((unsigned long int *)screen)+8+1)) +1)))&3)>1)))?(((((*(((char *) (((unsigned long int *)screen)+8+2)) +1)))>>2)&3)):(0), ((signed char) ( 127-((signed long)(2)*85))), ((signed char) (-128+((signed long)(2)*85))));
    drawRoom(0, ((0))?((((*(((char *) (((unsigned long int *)screen)+8+3)) +1)))&3)):(0), (((!((((*(((char *) (((unsigned long int *)screen)+8+2)) +1)))&3)>1)) && (!((((*(((char *) (((unsigned long int *)screen)+4+2)) +1)))&12)>4))))?(((((*(((char *) (((unsigned long int *)screen)+8+3)) +1)))>>2)&3)):(0), ((signed char) ( 127-((signed long)(2)*85))), ((signed char) (-128+((signed long)(3)*85))));

    drawRoom(0, (((!((((*(((char *) (((unsigned long int *)screen)+8+1)) +1)))&3)>1)) && (!((((*(((char *) (((unsigned long int *)screen)+8+1)) +1)))&12)>4))))?((((*(((char *) (((unsigned long int *)screen)+12+0)) +1)))&3)):(0), ((0))?(((((*(((char *) (((unsigned long int *)screen)+12+0)) +1)))>>2)&3)):(0), ((signed char) ( 127-((signed long)(3)*85))), ((signed char) (-128+((signed long)(0)*85))));
    drawRoom(0, ((!((((*(((char *) (((unsigned long int *)screen)+8+1)) +1)))&3)>1)))?((((*(((char *) (((unsigned long int *)screen)+12+1)) +1)))&3)):(0), ((0))?(((((*(((char *) (((unsigned long int *)screen)+12+1)) +1)))>>2)&3)):(0), ((signed char) ( 127-((signed long)(3)*85))), ((signed char) (-128+((signed long)(1)*85))));
    drawRoom(0, (((!((((*(((char *) (((unsigned long int *)screen)+8+1)) +1)))&3)>1)) && (!((((*(((char *) (((unsigned long int *)screen)+8+2)) +1)))&12)>4))))?((((*(((char *) (((unsigned long int *)screen)+12+2)) +1)))&3)):(0), ((0))?(((((*(((char *) (((unsigned long int *)screen)+12+2)) +1)))>>2)&3)):(0), ((signed char) ( 127-((signed long)(3)*85))), ((signed char) (-128+((signed long)(2)*85))));
...
void displayInn()
{
# 797 "C:\\Dev\\Vide\\projects\\Telengard\\source\\bank0\\main.c"
    saveSeed();
    unsigned long int m1 = cy;
    do {_x = ((unsigned int)((unsigned int) (m1*m1)));subBank1(2);} while(0);
    ...
    do {_x = ((unsigned int)((unsigned int) (cx+cy)));subBank1(2);} while(0);
    s2 = in2[RandMax(10)];

    do {_x = ((unsigned int)((unsigned int) (cx*3+cy*7)));subBank1(2);} while(0);
    s3 = in3[RandMax(10)];
    restoreSeed();
    ...
    while (1)
    {
        ...
        _Print_Str_d((const int)(-0x30), (const int)(0x0), (void *)(s1));
        _Print_Str_d((const int)(-0x10), (const int)(-0x10), (void *)(s2));
        _Print_Str_d((const int)(0x10), (const int)(-0x20), (void *)(s3));
